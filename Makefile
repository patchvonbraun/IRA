...
all: version integrated_ra_receiver receiver_start dtracker uhd_ra_receiver_new.py uhd_ra_interferometer.py
clean:
	rm -f *.o integrated_ra_receiver receiver_start exptime makekey installkit send  dtracker *.tar.gz
	rm -f uhd_ra_receiver_new.py
	rm -f uhd_ra_interferometer.py
	rm -f variables.dump
...
uhd_ra_interferometer.py: uhd_ra_interferometer.grc
	grcc -d . uhd_ra_interferometer.grc
